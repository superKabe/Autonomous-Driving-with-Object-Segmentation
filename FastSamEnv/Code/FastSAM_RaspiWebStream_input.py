"""
Capture a video stream from a specified URL, process each frame using a pre-trained FastSAM model to detect objects,
and overlay masks onto the frames based on the detected objects.
"""
...
url = 'http://192.168.1.70:8000/stream.mjpg' # Replace with IP 
...
# Function to overlay masks on frames
...
model = FastSAM(r'\weights\FastSAM.pt')  # FastSAM-s.pt or FastSAM-x.pt
